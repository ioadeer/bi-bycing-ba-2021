...
square brackets and consecutive numbers: \cite{}, \cite{},
\cite{} -- provided automatically
...
The following \cite{Shafae2021} section shows a sample reference list with entries for
journal articles ~\cite{OBrien2014}, an LNCS chapter \cite{}, a book
\cite{}, proceedings without editors \cite{} and
\cite{}, as well as a URL \cite{}.
